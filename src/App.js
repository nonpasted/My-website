...
function Skills() {
  const [ref, visible] = useInView();
  const skills = [
    { name: 'React / JSX', level: 92, color: '#61DAFB' },
...
const PROJECTS = [
  {
    ...
    desc: 'This very site — built with React, smooth scroll animations, and a macOS-inspired design language.',
  ...
  },
  {
    ...
    desc: 'A clean, real-time weather app with animated weather states and geolocation support.',
  ...
  },
  {
    ...
    desc: 'Drag-and-drop kanban board built with pure React hooks — no external libs.',
  ...
  },
  {
    ...
    desc: 'A visual explorer for linked lists, trees, and graphs — bridging my C++ skills with the web.',
    tags: ['C++', 'JavaScript', 'Canvas'],
    color: '#F59E0B',
    emoji: '🌳',
  },
  {
    title: 'E-Commerce UI Kit',
    desc: 'Accessible, pixel-perfect component library designed for modern storefronts.',
  ...
  {
    title: 'Island Blog',
    desc: 'A minimal blog about life in Hawaiʻi, built with a custom React rendering pipeline.',
    ...
    <section id="projects" className="projects-section">
      <div className="section-inner" ref={ref}>
        ...
        <p className={`section-sub ${visible ? 'visible' : ''}`}>
          A selection of things I've built — from web apps to systems programming explorations.
        </p>
  ...
  return (
    <section id="contact" className="contact-section" ref={ref}>
      <div className="section-inner">
        ...
        <p className={`section-sub ${visible ? 'visible' : ''}`}>
          Interested in working together? Send me a message — I'm always open to new projects.
        </p>
